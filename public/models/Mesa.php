...
class Mesa
{
    ...
    public static function CambiarEstado($codigo, $id_estado)
    {
        $objAccesoDato = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDato->prepararConsulta("UPDATE mesas set id_estado = :estado where codigo = :codigo");
        $consulta->bindValue(':codigo', $codigo, PDO::PARAM_STR);
        $consulta->bindValue(':estado', $id_estado, PDO::PARAM_INT);
        $consulta->execute();
    }
